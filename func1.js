...
function calculate() {
    ...
    var ea1=document.getElementsByClassName('ea')[0].value;         //className이 txtea1인 요소를 변수 ea1로 지정한다.
    var price1=document.getElementsByClassName('price')[0].value;   //className이 txtprice1인 요소를 변수 price1로 지정한다.
    ...
    document.getElementsByClassName('supply')[0].value=supply2;     //천 단위 콤마(,) 표시가 된 값을 ClassName이 txtsupply1인 요소에 반환
    document.getElementsByClassName('vat')[0].value=vat2;           //천 단위 콤마(,) 표시가 된 값을 ClassName이 txtvat1인 요소에 반환
    document.getElementsByClassName('total')[0].value=total2;       //천 단위 콤마(,) 표시가 된 값을 ClassName이 txttotal1인 요소에 반환
}
