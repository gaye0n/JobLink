...
<table width=98% style="border: 1px solid #d7d7d7">
	...
	<tr height=30>
		...
		<td class="tdd" align=center><nobr>
			<asp:TextBox Width="80%" ID="txtea1" class="ea" onchange="calculate()" onKeyup="inputNumberAutoComma(this);" runat="server" ></asp:TextBox>
		</td>

		<td class="tdd" align=center><nobr><asp:TextBox width="90%" ID="txtprice1" class="price" onchange="calculate()" onKeyup="inputNumberAutoComma(this);" runat="server" ></asp:TextBox>      
		</td>
...
<table width=98% border="1" bordercolor="#d7d7d7">
	<tr height=30>
		...
		<td class="tdd" align=left>
			<b><asp:DropDownList ID="txtcompany1" runat="server">
				...
				<asp:ListItem Value="NO24">NO24</asp:ListItem>
			</asp:DropDownList></b>
		</td>
