<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SCM_NoticeAddControl.ascx.cs" Inherits="Admin_SCM_NoticeAddControl" %>
 ...
 <link rel="stylesheet" href="build/kalendae.css" type="text/css" charset="utf-8">
	...
	<script src="build/Calc.js" type="text/javascript" charset="utf-8"></script>
...
<table width=98% style="border: 1px solid #d7d7d7">
	...
	<tr height=30>
		<td class="tdd" align=center>
			<asp:DropDownList ID="txtitem1" runat="server">
		...
		<td class="tdd" align=center>
			<asp:DropDownList ID="txtTitle" runat="server">
		...
		<td class="tdd" align=center>
			<b><asp:TextBox ID="txtsalesdate1"  class="auto-kal"  runat="server" Width="80%"></asp:TextBox></b>
		</td>

		<td class="tdd" align=center><nobr>
			<asp:TextBox Width="80%" ID="txtea1" class="ea" onKeyup="inputNumberAutoComma(this);" runat="server" ></asp:TextBox>
		</td>

		<td class="tdd" align=center><nobr>
			<asp:TextBox width="90%" ID="txtprice1" class="price" onchange="calculate()" onKeyup="inputNumberAutoComma(this);" runat="server" ></asp:TextBox>      
		</td>

		<td class="tdd" align=center><nobr><asp:TextBox Width="90%" ID="txtsupply1" class="supply" runat="server" ></asp:TextBox></td>

		<td class="tdd" align=center>
			<asp:TextBox Width="80%" ID="txtvat1" class="vat" runat="server"></asp:TextBox> 
		</nobr></td>

		<td class="tdd" align=center><b><asp:TextBox ID="txttotal1" class="total" runat="server"  Width="80%"></asp:TextBox></b></td>
	</tr>
</table>
<br> 
...
<table width="98%" border="1" bordercolor="#d7d7d7">
	<tr height=30>
		...
		<td width="40%" class="tdd" align="left"><b><asp:DropDownList ID="txtcompany1" runat="server">
				...
				<asp:ListItem Value="NO24">NO24</asp:ListItem></asp:DropDownList></b>
		</td>
